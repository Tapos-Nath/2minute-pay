...
.gasinforma{font-size:25px; font-family:arial; font-weight:bold; padding:30px 500px; color:#FFFFFF; float:left;}
...
<body>
 <div class="gas_info" style="height:80px; width:1350px; background:#1C93AD;">
   <span class="gasinforma">Electricity Bill History</span>
 </div>
<form name="form1" method="post" action="">
  <table width="1300" height="113" border="0" align="center">
	...
	{
	   mysql_query("DELETE FROM electricity_bill_history WHERE email='$email'");
  ...
  ?>
  <?php
    $select_op=mysql_query("SELECT * FROM electricity_bill_history WHERE email='$email'");
