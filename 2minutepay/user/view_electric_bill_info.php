...
.gasinforma{font-size:30px; font-family:arial; font-weight:bold; padding:19px 500px; color:#FFFFFF; float:left;}
...
<body>
 <div class="gas_info" style="height:80px; width:1350px; background:#1C93AD;">
   <span class="gasinforma">Electric Bill Information</span>
 </div>
<form name="form1" method="post" action="">
  <table width="1110" height="113" border="0" align="center">
	...
	<?php
	 $select=mysql_query("SELECT * FROM electricity_bill_info WHERE id='$customer_id'");
  ...
  $total_tx=$fetch_wallet['2']-650;
  mysql_query("UPDATE wallet SET amount='$total_tx' WHERE email='$email'");  
	 print"<script>location='home.php?p=confirm_elecbill'</script>";
	}
