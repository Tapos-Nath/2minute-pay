...
<form id="form1" name="form1" enctype="multipart/form-data" method="post" action="">
 <div class="gp_plane">
   <span class="design_his">Recharge & Talktime History</span>
 </div>
  ...
  <tr>
	...
	<td width="250" align="center"style="border-bottom:1px solid #F6F6F6;"><span class="sta_design">Valid Date</span></td>
	<td width="250" align="center"style="border-bottom:1px solid #F6F6F6;"><span class="sta_design">Date</span></td>
  </tr>
  <?php
   if(isset($_POST['delete']))
   {
      mysql_query("DELETE FROM recharge_talktime_history WHERE email='$email'");
	    if(mysql_affected_rows()>0)
		{
		 print"<script>alert('Clear Successfull')</script>";
		}
		else
		{
		 print"";
  ...
  <?php
	 $select_op=mysql_query("SELECT * FROM recharge_talktime_history WHERE email='$email'");
	...
	<td width="142" height="70" align="center" style="border-bottom:1px solid #F6F6F6;"><span class="design"><?php print $fetch_op['1']; ?></span></td>
    <td width="142" height="70" align="center" style="border-bottom:1px solid #F6F6F6;"><span class="design"><?php print $fetch_op['2']; ?></span></td>
      ...
      <td width="250" align="center" style="border-bottom:1px solid #F6F6F6;"><span class="design"><?php print $fetch_op['4']; ?></span></td>
	  <td width="250" align="center" style="border-bottom:1px solid #F6F6F6;"><span class="design"><?php print $fetch_op['4']; ?></span></td>
      </label>
    </tr>
	<?php
