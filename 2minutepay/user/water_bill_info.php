...
<body>
 <div class="gas_info" style="height:80px; width:1350px; background:#1C93AD;">
   <span class="gasinforma">Water Bill Information</span>
 </div>
<form name="form1" method="post" action=""> 
  <table width="1110" height="275" border="0" align="center">
    <tr>
      ...
      <td width="63" align="center" style="border-bottom:1px solid #E0E0E0;"><span class="design">Bill No</span> </td>
      <td width="67" align="center" style="border-bottom:1px solid #E0E0E0;"><span class="design">Zip Code</span></td>
      <td width="66" align="center" style="border-bottom:1px solid #E0E0E0;"><span class="design">Date</span></td>
      <td width="81"align="center" style="border-bottom:1px solid #E0E0E0;"><span class="design">Address</span></td>
      <td width="81" align="center" style="border-bottom:1px solid #E0E0E0;"><span class="design">Bill</span></td>
      <td width="186" align="center" style="border-bottom:1px solid #E0E0E0;"><span class="design">WASA name</span></td>
    </tr>
    <?php
	 $select=mysql_query("SELECT * FROM watter_bill_info WHERE id='$customer_id'");
  ...
  $total_tx=$fetch_wallet['2']-$fetch_info['6'];
  mysql_query("UPDATE wallet SET amount='$total_tx' WHERE email='$email'");  
   print"<script>location='home.php?p=confirm_water'</script>";
  }
	}
	?>
