...
color:#c58181;
margin-left:135px;
line-height:15px;"> Thank you ! Successfull Receive Your Gas Bill Payment </h3>
  <p style="font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:20px; color:#666; letter-specing:1px;"> 
</p>
 
 
    <font style="font-size:15px; color:#A6A6A6; margin-left:1px; font-family:arial; font-weight:500; margin-top:10px; float:left;">code:<?php print $code; ?></font><br><br>
       <font style="font-size:15px; color:#A6A6A6; margin-left:30px; font-family:arial; font-weight:500; margin-top:10px; float:left;">name:<?php print $name; ?></font><br><br>
       <font style="font-size:15px; color:#A6A6A6; margin-left:30px; font-family:arial; font-weight:500; margin-top:10px; float:left;">Number:<?php print $number; ?></font><br><br>
        <font style="font-size:15px; color:#A6A6A6; margin-left:30px; font-family:arial; font-weight:500; margin-top:10px; float:left;">Date:<?php print $date; ?></font><br><br>
