...
<h1 style="font-weight:bold; font-size:22px; color:#333333; font-family:Arial, Helvetica, sans-serif"># Your Shopping Cart Summary</h1>
...
<form  name="form1" method="post" action="">
  <table width="1156" border="0" cellpadding="1" cellspacing="1" style="border:1px #000">
    <tr>
      <td width="80" height="67" align="center"><h5><span class="style1">Select for delete </span></h5></td>
      <td width="118" align="center"><h5 class="style1">Sale no &amp; Qanutity </h5></td>
      <td width="107" align="center"><h5 class="style1">Product name </h5></td>
      <td width="296" align="center"><h5 class="style1">Product picture </h5></td>
      <td width="351" align="center"><h5 class="style1">Product details </h5></td>
      <td width="183" align="center"><h5 class="style1">Unit price </td>
    </tr>
    <?php
	...
	//print "$total_blance";
              ...
              $amount=0;
              $total=0;
               $select=mysql_query("SELECT * FROM shopping_card WHERE session_id='".session_id()."' AND product_id='$pdt_id'");
              ...
              ?>
    <tr>
      <td height="72" align="center"><label>
        <input type="checkbox" name="select[]" id="select[]" value="<?php print $fetch_card[2]?>">
      </label></td>
      <td align="center" style="font-family:Georgia, 'Times New Roman', Times, serif; font-weight:bold; color:#999999; font-size:12px; word-spacing:5px;"><input name="update_quantity[]" type="text" class="quantity" id="update_quantity[]" value="<?php print $fetch_card[5];?>" style="height:40px; width:80px; text-align:center;"></td>
      <td align="center" style="font-family:Georgia, 'Times New Roman', Times, serif; font-weight:bold; color:#999999; font-size:12px; word-spacing:5px;"><?php print $fetch_card['3'];?></td>
      <td align="center"><?php
  for($t=0; $t<4; $t++)
  {
  if($t==0)
  {
  ?>
          <img src="../images/product_image/<?php print $fetch_card[2]."($t)"?>.jpg" width="170px" height="180px" style="border:solid 2px #ccc">
          <?php
  }
  }
  ?>      </td>
      <td align="center" style="font-family:Georgia, 'Times New Roman', Times, serif; font-weight:bold; color:#999999; font-size:11px; word-spacing:5px;"><?php print $fetch_card[6]; ?></td>
      <td align="center" style="font-family:Georgia, 'Times New Roman', Times, serif; font-weight:bold; color:#909090"><?php print $fetch_card[4];?></td>
    </tr>
...
<input name="update" type="submit" class="remo1" id="update" value="Update Quantitiy">
      ...
      <td height="71" align="center" style="font-size:18px; font-weight:bold; color:#3C3C3C">Total : &nbsp;<input type="text" name="total" style="border:solid 1px #ccc; width:114px; height:40px; text-align:center; font-family:Arial, Helvetica, sans-serif; font-weight:bold;" value="<?php  print $total;?>" >
</td>
