...
$code=$_GET['code'];
 ...
 $comment=$_POST['details'];
  ...
  $select_home=mysql_query("SELECT * FROM home_delivary WHERE email='$email' AND code='$code'");
  $fetch_home=mysql_fetch_array($select_home);
...
color:#c58181;
margin-left:135px;
line-height:15px;"> Thank you ! Successfull Receive Your Shopping Bill Payment </h3>
  <p style="font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:20px; color:#666; letter-specing:1px;"> 
</p>
 
 
    <font style="font-size:15px; color:#A6A6A6; margin-left:1px; font-family:arial; font-weight:500; margin-top:10px; float:left;">Name:<?php print $fetch_home[2]; ?> <?php print $fetch_home[3]; ?></font><br><br>
       <font style="font-size:15px; color:#A6A6A6; margin-left:30px; font-family:arial; font-weight:500; margin-top:10px; float:left;">Address:<?php print $fetch_home[4] ?></font><br><br>
       <font style="font-size:15px; color:#A6A6A6; margin-left:30px; font-family:arial; font-weight:500; margin-top:10px; float:left;">City:<?php print $fetch_home[5]; ?></font><br><br>
        <font style="font-size:15px; color:#A6A6A6; margin-left:30px; font-family:arial; font-weight:500; margin-top:10px; float:left;">Postal Code:<?php print $fetch_home[6]; ?></font><br><br>
        <font style="font-size:15px; color:#A6A6A6; margin-left:30px; font-family:arial; font-weight:500; margin-top:10px; float:left;">Price:<?php print $fetch_home[7]; ?></font><br><br>
