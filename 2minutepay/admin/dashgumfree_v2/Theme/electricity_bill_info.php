...
<?php
 if(isset($_POST['add']))
 {
     mysql_query("INSERT INTO electricity_bill_info(`name`,`id`,`cd_no`,`bill_no`,`zip_code`,`date`,`address`,`price`,`company_name`)
	               VALUE('$name','$customer_id','$cd_no','$bill_no','$zip_code','$date','$address','$taka','$company_name')");
...
<div class="wrapper" style="height:auto; width:450; border:1px solid #999999; float:left;">
  <table width="450" border="0">
    ...
    <tr>
      <td height="36">CD NO:</td>
      <td><label>
        <input type="text" name="cd_no" placeholder="CD NO" style="height:35px; width:200px; border-radius:5px; background:#F2F2F2; float:left;">
      </label></td>
    </tr>
    <tr>
