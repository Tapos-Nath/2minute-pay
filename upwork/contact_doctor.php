<?php
    ...
    $id=$_GET['id'];
    $select_doctor=mysql_query("SELECT * FROM home_doctor WHERE id='$id'");
    $fetch_doctor=mysql_fetch_array($select_doctor);
print $id;
print $fetch_teacher[3];
...
if(isset($_POST['confirm'])){
    mysql_query("INSERT INTO order_doctor(`doctor_id`,`doctor_name`,`doctor_study`,`doctor_hospital_name`,`doctor_expart`,`doctor_address`,`order_user_name`,`order_user_phone`,`order_user_area`,`order_user_address`)VALUES('$fetch_doctor[0]','$fetch_doctor[1]','$fetch_doctor[3]','$fetch_doctor[4]','$fetch_doctor[6]','$fetch_doctor[7]','$name','$phone','$area','$address')");
...
<!--                            <img src="asset/img/avatar-5.jpg" alt="" style="height:130px;width:130px;border-radius:100%;margin-left: 178px;margin-top: -33px;padding: 5px;">-->
                        <h3 style="font-size:20px;color:gray;padding:0;margin:0;margin-top:-28px;font-weight:700;border-bottom:1px solid silver;padding:10px;">Teacher Details</h3>
                            <div class="details">
                                <p style="">ID : <?php print $fetch_doctor[0];?></p>
                                <p>NAME : <?php print $fetch_doctor[1];?></p>
                                <p>STUDYING : <?php print $fetch_doctor[3];?></p>
                                <p>AGE:<?php print $fetch_doctor[2] ?></p>
                                <p>Expart : <?php print $fetch_doctor[6]; ?></p>
                                <p>ADDRESS : <?php print $fetch_doctor[7];?></p>
                            </div>
                       </div>
                        <div class="col-md-6">
                            <img src="image/home_worker/<?php print $fetch_doctor[0]?>.jpg" alt="" style="height:130px;width:130px;border-radius:100%;margin-left: ;margin-top: -33px;padding: 5px;float:right">
<!--
