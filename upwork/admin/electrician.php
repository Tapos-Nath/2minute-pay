...
//     if(!empty($id)&& !empty($name)&& !empty($age)&& !empty($study)&& !empty($exp)&& !empty($expart)&& !empty($p_address)&& !empty($message)){
        mysql_query("INSERT INTO home_teacher(`id`,`name`,`age`,`study`,`scu`,`school`,`year`,`exp`,`expart`,`p_address`,`message`)VALUES('$id','$name','$age','$study','$scu','$school','$year','$exp','$expart','$p_address','$message')");
        if(mysql_affected_rows()>0){
            $img="../image/home_teacher/$id.jpg";
...
if(isset($_POST['delete'])){
    mysql_query("DELETE FROM home_teacher WHERE id='$id'");
    if(mysql_affected_rows()>0){
...
if(isset($_POST['edit'])){
    mysql_query("UPDATE home_teacher SET name='$name',age='$age',study='$study' WHERE id='$id'");
    if(mysql_affected_rows()>0){
        $su='Edit Successfull';
    }else{
      ...
      <div class="row">
          ...
          <br>
           <div class="col-md-4 col-md-offset-1">
              <h2 class="text-center" style="border-bottom:2px solid black;padding:10px;">Home electrician</h2>
              <br>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                   <label for="">School/collage/University</label>
                   <select name="scu" class="form-control" id="">
                       <option>Study Label</option>
       ...
       <div class="row">
           <div class="col-md-6 col-md-offset-1">
               <table class="table table-bordered">
                   ...
                   <?php
                    $select_table=mysql_query("SELECT * FROM home_teacher");
                   ...
                   <tr>
                       ...
                       <td><?php print $fetch_table[7]?></td>
                       <td><?php print $fetch_table[8]?></td>
                       <td><?php print $fetch_table[9]?></td>
                   </tr>
                   <?php } ?>
               </table>
           </div>
