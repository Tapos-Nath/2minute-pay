...
/*        .cat::after{*/
        ...
        span,p{
            font-family: 'Maven Pro', sans-serif;color:#222;font-size:14px;font-weight:500;text-align:left;
        }
        h3{
            color:#222;
  ...
  <body>
       <br><br>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="text-center borbtm" style="padding-bottom:;color:#222;font-family: 'Bree Serif', serif;">Our Avaiable Home Teacher</h1>
                </div>
            </div>
        </div>
        <br><br>
...
//    }
                ...
                $select_teacher=mysql_query("SELECT * FROM home_teacher");
                
                while($fetch_teacher=mysql_fetch_array($select_teacher)){
            ...
            <div class="col-md-3 pdg" style="border:2px solid silver;">
               <form action="" method="get" enctype="multipart/form-data">
                <div class="img">
                    <img src="image/home_teacher/<?php print $fetch_teacher[0]?>.jpg" alt="" style="height:120px;width:120px;border-radius:100%;border:2px solid gray">
                </div>
                <div class="address">
                    <h3 class="text-center"><?php print $fetch_teacher[1]?></h3>
                    <p class=""> <span style="font-weight:700;"><?php print $fetch_teacher[4]?></span> : <?php print $fetch_teacher[5]?></p>
                </div>
                <hr>
                   <p class=""><span style="font-weight:700;">Location</span>:<?php print $fetch_teacher[9]?></p>
                <hr>
                <div class="skill">
                    <span><?php print $fetch_teacher[8]?></span>
                    
                </div>
<!--                <input type="hidden" name="mk" value="<?php print $fetch_teacher[0]?>">-->
<!--                <a href="service.php?&page=teacher_profile &id=<?php print $fetch_teacher[0];?>" style="padding:10px 10px;background:orangered;color:white;text-align:center;margin-left: 20px;line-height: 80px;border-radius: 3px;font-family: 'Bree Serif', serif;">View Profile</a>-->
               <div class="botton-area" style="">
                   <a href="service.php?&page=contact_teacher&faq=abc&id=<?php print $fetch_teacher[0];?>" style="padding:10px 76px;background:orangered;color:white;text-align:center;margin-left: 10px;line-height: 80px;border-radius: 3px;font-family: 'Bree Serif', serif;">Book Now</a>
                </div>
            <!--                   <button type="submit" class="" name="book_now" data-toggle="modal" data-target="#myModal" style="background:#FF4500;color:white;border:none;border-radius:5px;padding:10px 10px;">Book Now</button>-->
             <!-- Button trigger modal -->
<!--
<button type="button" class="" data-toggle="modal" data-target="#myModal" style="background:#FF4500;color:white;border:none;border-radius:5px;padding:10px 10px;">
  Book Now
</button>
-->
<!--        <input type="button" class="" name="book_now" data-toggle="modal" data-target="#myModal" style="background:#FF4500;color:white;border:none;border-radius:5px;padding:10px 10px;" value="Book Now <?php print $fetch_teacher[0]?>" hire="<?php print $fetch_teacher[0];?>">-->
...
//                                $id=$_SESSION['id'];
//                                print $id;
                                    $fetch_teacher=$_SESSION['id'];
print $fetch_teacher[0];
                                ?>
                                <p style="">ID : <?php print $fetch_teacher[0];?></p>
                                <p>NAME : <?php print $fetch_teacher[1];?></p>
                                <p>STUDYING : <?php print $fetch_teacher[5];?></p>
