...
if(isset($_POST['next'])){
    ...
    print"<script>location='service.php?&page=contact_electrician'</script>";
}


//if(isset($_POST['submit'])){
//    mysql_query("INSERT INTO electrician(`area`,`service_name`,`address`,`name`,`phone`,`email`,`verification`)VALUES('$area','$service_name','$address','$name','$phone','$email','$verification')");
  ...
  <body>
       <br><br>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
<!--                    <h1 class="text-center" style="border-bottom:1px solid silver;padding-bottom:30px;color:black;font-family: 'Bree Serif', serif;">Our Avaiable Electrical Service</h1>-->
                </div>
            </div>
        </div>
        <br>  <br>  <br>
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h1 class="plum" style="padding-bottom:20px;color:#3E4551;font-family: 'Bree Serif', serif;">Electrical Service</h1>
                    ...
                    <br><br>
                    <div class="feature">
                        <h3  class="plum" style="padding-bottom:20px;color:#222;font-family: 'Bree Serif', serif;">Features</h3>
...
<!--                    <input type="text" class="input_type" name="service_name" placeholder="" style="font-size:22px;font-family: 'Maven Pro', sans-serif;border:2px solid #FF5E00;padding:27px 0;font-weight:500;color:#222;">-->
                        <select name="service_name" id="" style="font-size:22px;font-family: 'Maven Pro', sans-serif;border:2px solid #FF5E00;padding:13px 45px;font-weight:500;color:#222;">
                            <option>Choosse Your Service</option>
                           
                            <option> Household Wiring</option>
                            <option>Light Installation</option>
                            <option>Fan Installation</option>
                            <option>Fan Servicing</option>
                            <option>Water Motor Servicing</option>
                            <option>Generator Installation</option>
                            <option>Generator Repairing</option>
                            <option>UPS Repairing</option>
                            <option>IPS Servicing</option>
                        </select>
