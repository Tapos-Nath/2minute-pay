  ...
  <body>
   ...
   <div class="container">
           <?php
                ...
                $phone=$_POST['phone'];
                if(isset($_POST['send'])){
                    mysql_query("INSERT INTO users(`username`,`email`,`password`,`phone`)VALUES('$username','$email','$password','$phone')");
                    if(mysql_affected_rows()>0){
                        
                        print "<script>location='service.php?&page=food'</script>";
                    }else{
                        $u='Create Account Failed';
                    }
                }  
            ?>
            <div class="row">
                <div class="col-md-4 offset-md-4">
                   <form action="" method="post" enctype="multipart/form-data">
                       <br>
                       <span style="color:red"><?php print $u;?></span>
                       <br>
                        ...
                        <br>
                        <input type="submit" class="btn btn-success" name="send" value="Create Account">
                        <br>
                    </form>
                </div>
            </div>
