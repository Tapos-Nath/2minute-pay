...
<!--                            <img src="asset/img/avatar-5.jpg" alt="" style="height:130px;width:130px;border-radius:100%;margin-left: 178px;margin-top: -33px;padding: 5px;">-->
                        <h3 style="font-size:20px;color:gray;padding:0;margin:0;margin-top:-28px;font-weight:700;border-bottom:1px solid silver;padding:10px;">Driver Details</h3>
                            <div class="details">
                                <p style="">ID : </p>
                                <p>NAME : </p>
                                <p>STUDYING : </p>
...
-->
                    ...
                    <div class="form-group">
                       <input type="text" class="form-control" placeholder="Enter Your Name" style="height:34px;border: 1px solid #ccc;padding: 4px 0;border-radius: 4px;box-shadow: inset 0 1px 1px rgba(0,0,0,.075);font-weight:700;" required>
            <!--            <input type="text" class="form-control form_c">-->
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Enter Your Phone" style="height:34px;border: 1px solid #ccc;padding: 4px 0;border-radius: 4px;box-shadow: inset 0 1px 1px rgba(0,0,0,.075);font-weight:700;" required>
            <!--            <input type="text" class="form-control form_c">-->
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Enter Your Area" style="height:34px;border: 1px solid #ccc;padding: 4px 0;border-radius: 4px;box-shadow: inset 0 1px 1px rgba(0,0,0,.075);font-weight:700;" required>
<!--
...
-->
                    ...
                    <div class="form-group">
                        <textarea name="" class="form-control" id="" cols="30" rows="5" placeholder="Enter Your #house name #road number #area" style="font-weight:700;" required></textarea>
                    </div>
                   
                    <input type="submit" class="" value="Comfirm Booking" style="background:#FF5E00;padding:10px 192px;color:white;background:#FF5E00;border:none;border-radius:3px;font-weight:700;">
                  </div>
</form>
