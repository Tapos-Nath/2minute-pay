...
if(isset($_POST['next'])){
    ...
    print"<script>location='service.php?&page=contact_plumbing_service'</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<!--                    <h1 class="text-center" style="border-bottom:1px solid silver;padding-bottom:30px;color:#FF5E00;font-family: 'Bree Serif', serif;">Our Avaiable Plumbing Service</h1>-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h1 class="plum" style="padding-bottom:20px;color:#3E4551;font-family: 'Bree Serif', serif;">Plumbing Service</h1>
...
<!--                    <input type="text" class="input_type" name="service_name" placeholder="" style="font-size:22px;font-family: 'Maven Pro', sans-serif;border:2px solid #FF5E00;padding:27px 0;font-weight:500;color:#222;">-->
                        <select name="service_name" id="" style="font-size:22px;font-family: 'Maven Pro', sans-serif;border:2px solid #FF5E00;padding:13px 7px;font-weight:500;color:#222;">
                            <option>Choosse Your Service</option>
                            <option>Water Tap Fixing</option>
                    
                            <option>Kitchen Sink/ Basin Clog</option>
                            <option>Water Line Jam</option>
                            <option>Commode Low Down</option>
                            <option>Commode Jam</option>
                            <option>GAS Stove Installation</option>
                            <option>Complete New Sanitary Setup</option>
                        </select>
