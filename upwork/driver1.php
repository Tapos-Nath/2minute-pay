    ...
    <style>      
        ...
        .view {
            <?php
                $page=$_GET['page'];
            ?>
            background: url("asset/service/<?php print $page;?>.png")no-repeat center center fixed;
  ...
  <body>
       <br><br>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="text-center" style="border-bottom:1px solid silver;padding-bottom:30px;border-bottom:1px solid silver;padding-bottom:30px;color:#FF5E00;font-family: 'Bree Serif', serif;">Our Avaiable Driver</h1>
                </div>
            </div>
        </div>
     ...
     <div class="container contnr">
         <div class="row">
            ...
            <div class="col-md-3 pdg" style="border:2px solid silver;">
                <div class="img">
                    <img src="asset/img/avatar-1.jpg" alt="" style="height:120px;width:120px;border-radius:100%;border:2px solid gray">
                </div>
                <div class="address">
                    <h3 class="text-center">Arifulj Jamman</h3>
                    <p class="text-center">Web Designer</p>
                </div>
                <hr>
                <p class="text-center">Location:Bangladesh</p>
                <hr>
                <div class="skill">
                    <span>Math</span>
                    <span>English</span>
                ...
                <a href="service.php?&page=profile" style="padding:10px 10px;background:orangered;color:white;text-align:center;margin-left: 20px;line-height: 80px;border-radius: 3px;font-family: 'Bree Serif', serif;">View Profile</a>
                <a href="service.php?&page=contact_driver" data-toggle="modal" data-target="#myModal" style="padding:10px 10px;background:orangered;color:white;text-align:center;margin-left: 10px;line-height: 80px;border-radius: 3px;font-family: 'Bree Serif', serif;">Book Now</a>
             </div>
