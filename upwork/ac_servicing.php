...
if(isset($_POST['next'])){
    ...
    print"<script>location='service.php?&page=contact_ac_servicing'</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
       <br><br>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
<!--                    <h1 class="text-center" style="border-bottom:1px solid silver;padding-bottom:30px;color:#FF5E00;font-family: 'Bree Serif', serif;">Our Avaiable AC Service</h1>-->
                </div>
            </div>
        </div>
        <br>  <br>  <br>
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h1 class="plum" style="padding-bottom:20px;color:#3E4551;font-family: 'Bree Serif', serif;">AC  Service</h1>
                    
                    
                    <div class="content">
                       <br><br>
                        <p style="font-family: 'Maven Pro', sans-serif;color:#222;font-size:18px;font-weight:500;">
                    ...
                    <div class="feature">
                        ...
                        <br>
                        <p style="font-family: 'Maven Pro', sans-serif;color:#222;font-size:18px;font-weight:500;"><i class="fa fa-angle-double-right" aria-hidden="true" style="color:#FF5E00;"></i>Verified Plumbers with 10+ Years of Experience.</p>
                        <p style="font-family: 'Maven Pro', sans-serif;color:#222;font-size:18px;font-weight:500;"><i class="fa fa-angle-double-right" aria-hidden="true" style="color:#FF5E00;"></i>Shows Up at Your Place in Just 30 Minutes.</p>
                        <p style="font-family: 'Maven Pro', sans-serif;color:#222;font-size:18px;font-weight:500;"><i class="fa fa-angle-double-right" aria-hidden="true" style="color:#FF5E00;"></i>Transparent Pricing. No Hidden Charge.</p>
                        <p style="font-family: 'Maven Pro', sans-serif;color:#222;font-size:18px;font-weight:500;"><i class="fa fa-angle-double-right" aria-hidden="true" style="color:#FF5E00;"></i>All Kinds of Local and Foreign Sanitary Parts Available.</p>
                    </div>
                    <br><br>
                    <div class="sub_feature">
                        ...
                        <br>
                        <p style="font-family: 'Maven Pro', sans-serif;color:#222;font-size:18px;font-weight:500;">You can specify your booking by selecting one or more sub services from the drop down.</p>
                    </div>
                </div>
...
<!--                    <h3 class="fs-subtitle">This is step 1</h3>-->
                    ...
                    <input type="text" name="area" class="input_type" placeholder="" style="font-family: 'Maven Pro', sans-serif;border:2px solid #FF5E00;padding:27px 0;font-weight:500;color:#222;font-size:22px;" required>
...
<!--                    <input type="text" class="input_type" name="service_name" placeholder="" style="font-size:22px;font-family: 'Maven Pro', sans-serif;border:2px solid #FF5E00;padding:27px 0;font-weight:500;color:#222;">-->
                        <select name="service_name" id="" style="font-size:22px;font-family: 'Maven Pro', sans-serif;border:2px solid #FF5E00;padding:13px 50px;font-weight:500;color:#222;" required>
                    ...
                    <input type="text" name="address" class="input_type" placeholder="" style="font-family: 'Maven Pro', sans-serif;border:2px solid #FF5E00;padding:27px 0;font-size:22px;font-weight:500;color:#222; required">
