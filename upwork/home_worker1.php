    ...
    <style>      
        ...
        .view {
            <?php
                ...
                $page=$_GET['page'];
            ?>
            background: url("asset/service/<?php print $page;?>.jpeg")no-repeat center center fixed;
  ...
  <body>
       <br><br>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="text-center" style="border-bottom:1px solid silver;padding-bottom:30px;border-bottom:1px solid silver;padding-bottom:30px;color:#FF5E00;font-family: 'Bree Serif', serif;">Our Avaiable Home Worker</h1>
                </div>
            </div>
        </div>
     ...
     <div class="container contnr">
         <div class="row">
            <?php
             $select_home_worker=mysql_query("SELECT * FROM home_worker");
                while($fetch_home_worker=mysql_fetch_array($select_home_worker)){
            ...
            <div class="col-md-3 pdg" style="border:2px solid silver;">
                <div class="img">
                    <img src="image/home_worker/<?php print $fetch_home_worker[0];?>.jpg" alt="" style="height:120px;width:120px;border-radius:100%;border:2px solid gray">
                </div>
                <div class="address">
                    <h3 class="text-center"><?php print $fetch_home_worker[1];?></h3>
                    <p class="text-center">Age : <?php print $fetch_home_worker[2]; ?></p>
                </div>
                <hr>
                <p class="text-center">Address : <?php print $fetch_home_worker[6];?></p>
                <hr>
                <div class="skill">
                   
                    <p>Expart</p>
                    <span style="font-size:18px;"><?php print $fetch_home_worker[5]?></span>
                    
                </div>
                <a href="service.php?&page=home_worker_profile&id=<?php print $fetch_teacher[0];?>" style="padding:10px 10px;background:orangered;color:white;text-align:center;margin-left: 20px;line-height: 80px;border-radius: 3px;font-family: 'Bree Serif', serif;">View Profile</a>
               <a href="service.php?&page=contact_home_worker&id=<?php print $fetch_home_worker[0];?>" style="padding:10px 10px;background:orangered;color:white;text-align:center;margin-left: 10px;line-height: 80px;border-radius: 3px;font-family: 'Bree Serif', serif;">Book Now</a>
             </div>
