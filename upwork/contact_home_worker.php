...
//session_start();
    ...
    $select_worker=mysql_query("SELECT * FROM home_worker WHERE id='$id'");
    $fetch_worker=mysql_fetch_array($select_worker);
...
if(isset($_POST['confirm'])){
    mysql_query("INSERT INTO order_worker(`worker_id`,`worker_name`,`worker_study`,`worker_expart`,`worker_address`,`order_user_name`,`order_user_phone`,`order_user_area`,`order_user_address`)VALUES('$fetch_worker[0]','$fetch_worker[1]','$fetch_worker[3]','$fetch_worker[5]','$fetch_worker[6]','$name','$phone','$area','$address')");
...
<!--    <link rel="stylesheet" href="basic.css">-->
    <style>      
        ...
        /*Intro*/
        .view {
            background: url("asset/img/<?php print $page?>.jpeg")no-repeat center center fixed;
...
/*        .cat::after{*/
       ...
       p{
            font-family: 'Maven Pro', sans-serif;color:#222;font-size:18px;font-weight:500;line-height:10px;
        }
        .form-control{
            display: block;
            width: 100%;
...
<!--                            <img src="asset/img/avatar-5.jpg" alt="" style="height:130px;width:130px;border-radius:100%;margin-left: 178px;margin-top: -33px;padding: 5px;">-->
                        <h3 style="font-size:20px;color:gray;padding:0;margin:0;margin-top:-28px;font-weight:700;border-bottom:1px solid silver;padding:10px;">Teacher Details</h3>
                            <div class="details">
                                <p style="">ID : <?php print $fetch_worker[0];?></p>
                                <p>NAME : <?php print $fetch_worker[1];?></p>
                                <p>STUDYING : <?php print $fetch_worker[3];?></p>
                                <p>AGE:<?php print $fetch_worker[2] ?></p>
                                <p>Expart : <?php print $fetch_worker[5]; ?></p>
                                <p>ADDRESS :<?php print $fetch_worker[6];?></p>
                            </div>
                       </div>
                        <div class="col-md-4">
                            <img src="image/home_worker/<?php print $fetch_worker[0]?>.jpg" alt="" style="height:130px;width:130px;border-radius:100%;margin-left: ;margin-top: -33px;padding: 5px;float:right">
<!--
