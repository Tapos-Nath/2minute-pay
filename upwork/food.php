...
//                                    print $id;
//                                    print session_id();
//                                $mysql_query=mysql_query("SELECT * FROM food_menu WHERE id='".session_id()."'");
//                                $fetch_query=mysql_fetch_array($mysql_query);
                                
                                   ?>
-->
                                  <a href="service.php?page=food&id=<?php print $fetch_food_menu[0]; ?>"><span class="add">Add</span></a>
...
<!--                                   <a href=""><p>Tk.300 <span class="add">add</span></p></a>-->
                               ...
                               <div class="col-md-2">    
<!--                                    <a href="servce.php?&page=food&id="><span class="add">Add</span></a>-->
<input type="submit" class="add" name="add" value="Add"></a>
                               </div>
                           </div>
                           <hr>
...
//            $fetch_food_menu[0]=$_GET['id'];
//print $id;
//print $fetch_food_menu[0];
//print "<br>";
//$select_food_item=mysql_query("SELECT * FROM food_item WHERE id='$fetch_food_menu[0]'");
...
//            
            ?>
            <?php 
$select_value=mysql_query("SELECT * FROM food_item");
$fetch_value=mysql_fetch_array($select_value);
print $fetch_value[0];
print $fetch_value[1];  
print $fetch_value[2];
...
if(isset($_post['add']))
{
            mysql_query("INSERT INTO order_food(`id`,`email`,`session_id`,`item`,`catagory`,`single_double`,`price`)VALUES('$fetch_value[0]','$email','".session_id()."','$fetch_value[2]','$fetch_value[3]','$fetch_value[4]','$fetch_value[5]')");  
...
//                      $select_food_order=mysql_query("SELECT * FROM order_food WHERE session_id='".session_id()."'");
//                        while($fetch_food_order=mysql_fetch_array($select_food_order)){
//                     print "hi"; 

                    ?>
                    <tr>
                       <td>
                   <p><?php print $fetch_food_order[3];?></p>
                   <?php print 'allah';?>
<!--
...
--><span style="margin-left: 46px;
    font-weight: bold;
    font-size: 25px;"><?php print $fetch_food_order['5']?></span> 
                                           <hr> 
