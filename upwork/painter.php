...
if(isset($_POST['next'])){
    ...
    print"<script>location='service.php?&page=contact_paint_service'</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
/*           background: url("asset/service/painter (2).png")no-repeat center center fixed;*/
  ...
  <body>
       <br><br>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
<!--                    <h1 class="text-center" style="border-bottom:1px solid silver;padding-bottom:30px;color:#FF5E00;font-family: 'Bree Serif', serif;">Our Avaiable Painter Service</h1>-->
                </div>
            </div>
        </div>
        <br>  <br>  <br>
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h1 class="plum" style="padding-bottom:20px;color:#3E4551;font-family: 'Bree Serif', serif;">Painter Service</h1>
