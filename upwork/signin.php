  ...
  <div class="container">
      <?php
       ...
       $select_users=mysql_query("SELECT * FROM users WHERE email='$email'");
        $fetch_users=mysql_fetch_array($select_users);
       
        if(isset($_POST['login'])){
//            print $fetch_users[2];
            if($email==$fetch_users[2]){
                if($password==$fetch_users[3]){
                    
                    $_SESSION['email']=$email;
                    $_SESSION['loginfo']=true;
                    
                    print "<script>location='service.php?&page=food_product'</script>";
                }else{
       ...
       <div class="row">
           <div class="col-md-4 offset-md-4">
               <form action="" method="post" enctype="multipart/form-data">
                   ...
                   <a href="service.php?&page=signup"  style="float:right">Crete Account??</a>
                   <br>
